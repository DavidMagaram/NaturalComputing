...
\begin{table}[h]
\centering
\caption{Baseline Validation across Test Splits (Unchunked Training, $n=10$, $r=4$)}
...
\hline
7  & 0.8912 & 0.9396 & 0.9396 & 0.9388 & 0.9236\\
10 & 0.9106 & 0.9344 & 0.9344 & 0.9344 & 0.9222 \\
15 & NaN    & NaN    & NaN    & 0.9724 & -      \\
\hline
\end{tabular}
\end{table}

The results in Table 2 indicate that a larger chunk size generally improves discriminative power, provided $r$ is scaled appropriately. However, a significant limitation was observed at $n=15$ with low $r$ values ($r \le 4$), which resulted in NaN (Not a Number) errors. This likely 
